...
public class LogAdvice {
	...
	/*
	 * AspectJ Expression Language (AspectJ EL) => Advice가 적용될 JoinPoint에 대한 설정 문법
	 * 
	 * * :all .. : 0개 이상(패키지에 사용할 때는 하위패키지 모두) [] : 생략 가능 || : or &&: and ! : not ()
	 * : 인자 없음 (*) : 인자 1개 (*,*) : 인자 2개 (..) : 인자 0개 이상
	 * 
	 */
	...
	@AfterThrowing(pointcut = "execution(* kr.kwangan2.aop.service.SampleService*.*(..))",
								throwing="exception")
